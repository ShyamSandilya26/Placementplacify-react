...
export default function SubmitApplication() {
  ...
  const location = useLocation(); // Retrieve job details passed from SearchJobs.jsx

  const job = location.state; // Get job details from the passed state
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Call the API using the base URL
      await api.post("/student/submitapplication", formDataToSend, {
        headers: {
  ...
  return (
    <div>
      ...
      <div className="bg-white p-6 rounded-lg shadow-md max-w-lg mx-auto">
        ...
        <p className="text-gray-700 font-medium">{job?.companyname || "Company Name"}</p>
